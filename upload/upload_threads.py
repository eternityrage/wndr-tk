...
GITHUB_REPO = "eternityrage/wndr-tk"
GITHUB_RAW = f"https://raw.githubusercontent.com/{GITHUB_REPO}/main/wndr_tk_short.mp4"


def host_video_on_github(video_path_obj):
    """
    Commit the video into the repo at wndr_tk_short.mp4 and return its
